        ...
        <div className="relative flex flex-col h-full">
          ...
          <nav className="h-full overflow-y-auto px-2">
            <ul className="space-y-1 text-sm">
              ...
              <li>
                <Link href="/doctor/appointments" className={getLinkClass("/doctor/appointments")}>
                  My Appointments
                </Link>
              </li>
              <li>
                <Link href="/doctor/myPatients" className={getLinkClass("/doctor/myPatients")}>
                  My Patients
                </Link>
              </li>

              <li>
                <Link href="/doctor/reportsDoctor" className={getLinkClass("/doctor/reportsDoctor")}>
                  Reports
                </Link>
              </li>

              <li>
                <Link href="/doctor/notifications" className={getLinkClass("/doctor/notifications")}>
                  Notifications
                </Link>
              </li>

              <li>
                <Link href="/doctor/settings" className={getLinkClass("/doctor/settings")}>
                  Settings
                </Link>
              </li>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="leading-tight">
                  <span className="text-sm font-medium text-gray-800">Dr. John Doe</span> <br/>
